...
const Enter: NextPage = () => {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">Enter to Mango</h3>
      <div className="mt-12">
        ...
        <form className="flex flex-col mt-8">
          ...
          <button className="mt-5 bg-amber-500 hover:bg-amber-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 focus:outline-none ">
